//
//  main.c
//  TEST 7.14 Card Shuffling and Dealing Ext.
//
//  Created by Courtney Holsinger on 7/23/15.
...
void playerRank( size_t wHands[PLAYERS][HAND]){
    ...
    unsigned int player1 = determingPlayerHand(wHands[0]);
    unsigned int player2 = determingPlayerHand(wHands[1]);
